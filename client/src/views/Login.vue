<template>
  <div class="m-6">
    ...
    <p>Want to become a verifier? Contact me - <i class="fab fa-discord"></i> Ricochet#0001</p>
  </div>
  <form id="submissionForm">
    <div class="m-6" style="width:25%;">
      <div class="field">
        ...
        <div class="control">
          <input class="input" type="text" placeholder="Text input" name="email" id="email-text-field" maxlength="64">
        </div>
        <p class="help is-danger" id="is-email-blank" style="display:none;">This field cannot be blank!</p>
      </div>

      <div class="field">
        <label class="label" for="password">Password</label>
        <div class="control">
          <input class="input" type="password" placeholder="Text input" name="password" id="password-text-field" maxlength="64">
        </div>
        <p class="help is-danger" id="is-password-blank" style="display:none;">This field cannot be blank!</p>
      </div>
